 ...
 * 2014-04-02T10:51:12.396-06:00
 * Generated source version: 2.7.10
 * 
 */
@WebServiceClient(name = "Service", 
					wsdlLocation = "http://unigis2.unisolutions.com.ar/HUB/UNIGIS/MAPI/SOAP/COMMServer/service.asmx?wsdl",
						targetNamespace = "http://www.assistcargo.com/") 
public class Service extends javax.xml.ws.Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.assistcargo.com/", "Service");
    public final static QName ServiceSoap = new QName("http://www.assistcargo.com/", "ServiceSoap");
    public final static QName ServiceSoap12 = new QName("http://www.assistcargo.com/", "ServiceSoap12");
    public final static QName ServiceHttpPost = new QName("http://www.assistcargo.com/", "ServiceHttpPost");
    public final static QName ServiceHttpGet = new QName("http://www.assistcargo.com/", "ServiceHttpGet");
    static {
        URL url = null;
        try {
            url = new URL("http://unigis2.unisolutions.com.ar/HUB/UNIGIS/MAPI/SOAP/COMMServer/service.asmx?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://unigis2.unisolutions.com.ar/HUB/UNIGIS/MAPI/SOAP/COMMServer/service.asmx?wsdl");
        }
        WSDL_LOCATION = url;
    }
